...
unless Object.constants.include? :HelpersTest
  module HelpersTest
    class RespBody < Modern::Struct
      attribute :a, Modern::Types::Strict::String
    end
    ...
    module Helper
      def do_a_help
        RespBody.new(a: "this is from my helper")
      end
    end
  end
end
...
shared_context "helpers routes" do
  let(:helper_route) do
    Modern::Descriptor::Route.new(
      id: "getHelperValue",
      http_method: :GET,
      path: "/helper-value",
      summary: "a route that returns a value generated by a scoped helper",
      parameters: [],
      helpers: [HelpersTest::Helper],
      responses: [
        Modern::Descriptor::Response.new(
          http_code: :default,
          content: [
