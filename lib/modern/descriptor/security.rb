...
module Modern
  module Descriptor
    module Security
      ...
      # Securities in Modern allow for specifying the "plumbing" bits of the security
      # in a predictable, unsurprising way. If you specify that you use HTTP authorization
      # with the `Foobar` scheme--great. Modern finds the authorization header, checks
      # to see if it's Foobar type, and retrieves the
